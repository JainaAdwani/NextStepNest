...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <div className='p-8 max-w-lg mx-auto border-2 border-yellow-900/50 rounded-2xl bg-whitesmoke'>
      <h1 className='text-yellow-900/90 text-center text-4xl font-semibold my-10'>Profile</h1>
      ...
      <div className='flex justify-between mt-5'>
        ...
        <span onClick={handleSignOut} className='text-red-700 cursor-pointer hover:underline hover:text-red-600 hover:font-semibold'>
          Sign out
        </span>
      </div>
      ...
      <button onClick={handleShowListings} className='text-green-700 w-full hover:underline hover:text-green-600 hover:font-semibold'>
        Show Listings
      </button>
