...
export default function Profile() {
  ...
  return (
    <div className='p-5 max-w-lg mx-auto border-2 border-rose-700 rounded-2xl my-28 '>
      <h1 className='text-rose-700 text-center text-4xl font-semibold my-10'>Profile</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input type="text" placeholder="username" defaultValue={currentUser.username} className='border-rose-700 border p-3 rounded-lg bg-black text-white focus:outline-none active:outline-rose-700' id='username' onChange={handleChange}/>
        <input type="text" placeholder="username" defaultValue={currentUser.email} className='border-rose-700 border p-3 rounded-lg bg-black text-white focus:outline-none active:outline-rose-700' id='email' onChange={handleChange}/>
      ...
      <p className="text-rose-600 mt-4">{error ? error : '' }</p>
