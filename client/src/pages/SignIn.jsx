...
export default function SignIn() {
  ...
  return (
    <div className='p-5 max-w-lg mx-auto border-2 border-rose-700 rounded-2xl my-36'>
      <h1 className='text-rose-700 text-center text-4xl font-semibold my-10'>SignIn</h1>
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      <input type="text" placeholder="username" className='border-yellow-900/50 border p-3 rounded-lg bg-yellow-900/5 text-slate-900/90 focus:outline-none active:outline-yellow-900/50 placeholder:text-slate-400' id='username' onChange={handleChange}/>
      <input type="password" placeholder="password" className='border-yellow-900/50 border p-3 rounded-lg bg-yellow-900/5 text-slate-900/90 focus:outline-none active:outline-yellow-900/50 placeholder:text-slate-400' id='password' onChange={handleChange}/>
